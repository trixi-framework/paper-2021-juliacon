  ...
  \begin{subfigure}{\linewidth}
    \begin{tikzpicture}[
      ...
      \begin{axis}[
        ...
        % \addplot[blue, mark=square*, solid]
  ...
  \begin{subfigure}{\linewidth}
    \begin{tikzpicture}[
      ...
      \begin{axis}[
        ...
        % \node at (axis cs:10,0.6) {Will be improved soon};
      \end{axis}
    \end{tikzpicture}
