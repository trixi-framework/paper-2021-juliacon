...
\todo{TODO: p4est \cite{burstedde2011p4est} (HDF5)} %TODO
...
Multi-physics with 350 lines of code \cite{schlottkelakemper2021purely}
\todo{TODO} %TODO

\subsubsection{\trixi can be extended from outside}
...
\todo{TODO %TODO
\begin{itemize}
  \item Compilation time can be annoying (serial compiler!) but also allows cool features and performance
