...
C/C++/Fortran compilers. In particular, most LLVM frontends (including Julia) do
not enable fused multiply-add (FMA) contraction by default, while GCC and Intel
