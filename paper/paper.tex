...
Julia being built on top of LLVM, which does not perform the same code optimizations as other
...
An additional example is given by automatic differentiation. Due to dynamic multiple dispatch,
...
to not step on anybodies toes...} %TODO Michael
