...
\todo{TODO: Keep the plot of this comparison with the \lstinline{TreeMesh}?}
  ...
  \begin{subfigure}{\linewidth}
    \begin{tikzpicture}[
      ...
      \begin{axis}[
        ...
        \addplot[orange, mark=*, solid] % TreeMesh, weak form
          table [x index=0, y index=1]{../data/pids_euler_weak_cartesian.dat};
          \addlegendentry{Weak form}

        \addplot[orange, mark=*, dashed] % TreeMesh, flux differencing
          table [x index=0, y index=1]{../data/pids_euler_ranocha_cartesian.dat};
          \addlegendentry{Flux differencing}
      \end{axis}
    \end{tikzpicture}
  \end{subfigure}%
