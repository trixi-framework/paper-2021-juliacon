...
\begin{itemize}
  \item Julia is suited for simulation-focused scientific computing but some
        things need to be improved/demonstrated for HPC
  \item Julia allows us to do some cool stuff in \trixi
...
\begin{itemize}
  ...
  \item Shall we compare \trixi (in terms of structure, not performance!)
        ...
        \begin{itemize}
          \item Everything in Julia, not a two language problem!
          \item Other things? Gregor will think about it!
        \end{itemize}
