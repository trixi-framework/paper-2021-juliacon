...
Julia does not perform automatic fused multiply-add (FMA) contraction, i.e.,
...
In other compilers, this optimization can be controlled by a global compiler option
(\lstinline{-ffp-contract} in GCC and Clang) and is often enabled at reasonable
