...
\todo{I am not super happy about using KHI for a shock capturing demonstration. There are no shocks in a KHI - so it is a bit weird. I would reformulate this to "demonstrates non-linear stability via positivity and entropy-stability with adaptive mesh refinment....}
...
\todo{Maybe we can add a particular shock capturing test case as well, like Sedov with AMR, or the new Mach 2000 jet :-)}
...
v0.3.55 (August 2021), \trixi comes with \ca 200 example elixirs. A basic elixir
